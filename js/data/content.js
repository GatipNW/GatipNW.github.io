...
export const STRINGS = {
  th: {
    ...
    ui: {
      ...
      slide: 'สไลด์',
      sections: 'หัวข้อ',
      interactBtn: 'เปิดวัตถุที่อยู่ใกล้',
      aboutToggle: 'อ่านเพิ่ม',
    },
    zones: {
    ...
    resume: {
      ...
      back: '🎮 กลับเข้าเกม',
      summary: [
        'ทำงาน localization เกม, LQA และการตลาดสำหรับตลาดไทย จากภาษาญี่ปุ่นและอังกฤษเป็นไทย',
        'ผลงานที่เผยแพร่แล้ว 13 เกมบน Steam และงาน LQA บนเครื่องคอนโซลกับเกมระดับ AAA (รายละเอียดอยู่ภายใต้ NDA)',
        'มีประสบการณ์เสริมด้านงานอีเวนต์เกม ล่ามญี่ปุ่น–ไทย และช่อง YouTube เกี่ยวกับเกมและ Japanese pop culture',
        'มองหางานในอุตสาหกรรมเกมและบันเทิง โดยสนใจญี่ปุ่นเป็นเป้าหมายหลัก',
      ],
      ...
      facts: [
        ...
        { k: 'สถานะการทำงาน', v: 'อยู่ประเทศไทย — หากรับงานในญี่ปุ่นต้องดำเนินการเรื่องวีซ่าทำงาน (ยินดีเตรียมเอกสารฝั่งผู้สมัคร)' },
      ...
      colophon: 'เว็บนี้ผมออกแบบ กำกับทิศทาง และตัดสินใจทุกอย่างเอง — ตัวเว็บนับเป็นผลงานอีกชิ้นหนึ่ง',
      aboutHead: 'เกี่ยวกับเว็บนี้',
      about: [
        'แนวคิด โครงสร้าง เนื้อหา และการตัดสินใจด้านดีไซน์ทั้งหมดเป็นของผม โค้ดเขียนร่วมกับ Claude (AI) เป็นคู่เขียนหลัก',
        'Vanilla JS + Canvas 2D ไม่ใช้ framework · ฉากห้องสมุด สไลด์ และโลโก้เจนด้วยสคริปต์ Python (numpy/pillow) · ตู้เกม ชั้นหนังสือ และวัตถุในห้องวาดด้วยโค้ด · ตัวละครกระติ๊บเป็นภาพวาดเดิม ทำแอนิเมชันด้วยโค้ด (ไม่ได้สร้างสไปรต์ใหม่)',
        'ทดสอบด้วยสคริปต์อัตโนมัติ (Edge headless) และตรวจด้วยตาบน desktop และมือถือก่อนขึ้นเว็บทุกครั้ง',
      ],
  ...
  en: {
    ...
    ui: {
      ...
      slide: 'Slide',
      sections: 'Sections',
      interactBtn: 'Open the nearby object',
      aboutToggle: 'Read more',
    },
    zones: {
      'cab-sticky': 'Sticky Rice · Cherry Kiss',
      'cab-dh': 'DIGITAL HEARTS',
    ...
    resume: {
      ...
      summary: [
        'I work in game localization, LQA and marketing for the Thai market, from Japanese and English into Thai.',
        '13 titles shipped with Thai on Steam, plus console LQA on AAA titles (details under NDA).',
        'Additional experience in game events, Japanese–Thai interpreting, and a YouTube channel about games and Japanese pop culture.',
        'Seeking a role in the game or entertainment industry, with Japan as my main target.',
      ],
      ...
      facts: [
        ...
        { k: 'Work status', v: 'Based in Thailand — a work visa would need to be arranged for a role in Japan (happy to prepare the applicant-side paperwork)' },
      ...
      colophon: 'I designed and directed this site and made every call on it — the site itself is part of the portfolio.',
      aboutHead: 'About this site',
      about: [
        'Concept, structure, content and all design decisions are mine; the code was written together with Claude (AI) as my main pair-programmer.',
        'Vanilla JS + Canvas 2D, no framework · the library scene, showcase slides and logo cards are generated by Python scripts (numpy/pillow) · cabinets, book sets and props are drawn in code · the mascot is the original illustration, animated in code (no new sprite sheet was made).',
        'Tested with automated scripts (headless Edge) and checked by eye on desktop and mobile before each release.',
      ],
  ...
  ja: {
    ...
    resume: {
      ...
      back: '🎮 ゲームにもどる',
      summary: [
        'ゲームのタイ語ローカライズ・LQA・タイ市場向けマーケティングに従事しています（日本語・英語 → タイ語）。',
        'Steamで13タイトルのタイ語版をリリースし、AAA家庭用タイトルの実機LQAも担当しています（詳細はNDAのため非公開）。',
        'ゲームイベントの運営、日タイ通訳、ゲーム・日本のポップカルチャーを扱うYouTubeチャンネルの経験もあります。',
        'ゲーム・エンターテインメント業界での就業を希望しており、特に日本を第一の目標としています。',
      ],
      ...
      facts: [
        ...
        { k: '在留資格', v: '現在タイ在住 — 日本での就業には在留資格の取得手続きが必要です（申請者側の書類準備には対応いたします）' },
        { k: '居住地', v: 'タイ・ノンタブリー' },
      ],
      ctaHead: '🎉 すべての棚を見ていただきました — ありがとうございます',
      ctaBody: '募集中のポジションに合いそうでしたら、ぜひお気軽にご連絡ください。',
      updated: '最終更新: 2026年9月',
      colophon: 'このサイトは自ら設計・ディレクションし、すべての判断を行いました — サイト自体もポートフォリオの一部です。',
      aboutHead: 'このサイトについて',
      about: [
        'コンセプト・構成・内容・デザイン上の判断はすべて本人によるものです。コードはClaude（AI）をペアプログラマーとして共同で作成しました。',
        'Vanilla JS + Canvas 2D、フレームワーク不使用 · 図書館のシーン、スライド、ロゴカードはPythonスクリプト（numpy/pillow）で生成 · 筐体・本棚・小物はコードで描画 · マスコットは元のイラストをコードでアニメーション（新規スプライトは作成していません）',
        '公開前に自動テスト（ヘッドレスEdge）とデスクトップ・モバイルでの目視確認を行っています。',
      ],
