...
const BGM_FILE_VOL = 0.025;

// ★ 2026-07-20: เจ้าของสั่งลดเสียงเอฟเฟกต์ลง 1/3 (เหลือ 2/3 ของเดิม)
//   คูณรวมที่ tone()/noise() ที่เดียว — ไม่ต้องไล่แก้ gain ทีละเสียงใน play()
const SFX_GAIN = 0.67; // ★ ประวัติที่เจ้าของสั่ง: 0.35 → 0.175 → 0.05 → 0.025
